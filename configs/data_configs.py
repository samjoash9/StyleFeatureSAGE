...
DATASETS = {
    ...
    'vgg_encode' : {
        'transforms': transforms_config.EncodeTransforms,
		'train_source_root': dataset_paths['vgg_train'],
		'train_target_root': dataset_paths['vgg_train'],
		'valid_source_root': dataset_paths['vgg_valid'],
		'valid_target_root': dataset_paths['vgg_valid'],
	}
}
